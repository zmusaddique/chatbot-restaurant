...
def insert_order_item(food_item, quantity, order_id):
    try:
        ...
        print("Order item inserted successfully! wooookhhoooo")

        return 1

    except mysql.connector.Error as err:
        print(f"Error inserting order item: {err} yupp")
...
def insert_order_tracking(order_id, status):
    ...
    insert_query = f"INSERT INTO order_tracking (order_id, status) VALUES (%s, %s)"
